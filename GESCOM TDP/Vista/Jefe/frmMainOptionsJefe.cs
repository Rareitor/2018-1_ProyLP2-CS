...
namespace Vista
{
    public partial class frmMainOptionsJefe : Form
    {
        public frmMainOptionsJefe()
        {
            InitializeComponent();
        }
        ...
        {
            VisualizarComisionista visualizarComisionista = new VisualizarComisionista();
            visualizarComisionista.Owner = this;
            visualizarComisionista.ShowDialog();
        }
